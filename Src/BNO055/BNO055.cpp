...
//BNO055::BNO055( I2C_HandleTypeDef *hi2c1, uint16_t _address) {
//	hi2c = hi2c1;
//	address = _address;
//	accel_scale = 0.001f;
//	rate_scale = 1.0f/16.0f;
...
bool BNO055::check(){
	...
	HAL_I2C_Master_Receive(hi2c, address+1,rawdata,7,0xFF);
	...
	HAL_I2C_Master_Transmit(hi2c,address,tx,1,0xFF);
	HAL_I2C_Master_Receive(hi2c, address+1,(uint8_t*)ID.serial,16,0xFF);
	setpage(0);
	return true;
}
...
void BNO055::get_accel(void){
	...
	HAL_I2C_Master_Transmit(hi2c,address,tx,1,0xFF);
	HAL_I2C_Master_Receive(hi2c, address+1,rawdata,6,0xFF);
...
void BNO055::get_quat(void){
	...
	HAL_I2C_Master_Transmit(hi2c,address,tx,1,0xFF);
	HAL_I2C_Master_Receive(hi2c, address+1,rawdata,8,0xFF);
...
void BNO055::read_calibration_data(void){
	...
	HAL_I2C_Master_Transmit(hi2c,address,tx,1,0xFF);
	HAL_I2C_Master_Receive(hi2c, address,calibration,6,0xFF);
